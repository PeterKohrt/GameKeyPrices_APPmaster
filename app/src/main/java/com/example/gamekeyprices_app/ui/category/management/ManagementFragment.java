...
public class ManagementFragment extends Fragment {
    ...
    private ProgressBar management_progressbar;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        game_list_view = view.findViewById(R.id.management_recycler);
        ...
        management_progressbar = view.findViewById(R.id.progressBar_management);
        management_progressbar.setVisibility(View.VISIBLE);
    ...
    private void loadQuery(String county, String region) {
        ...
        final String g9 = "prisonarchitect";
        final String g10 = "motorsportmanager";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            management_progressbar.setVisibility(View.INVISIBLE);
