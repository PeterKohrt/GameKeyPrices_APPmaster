package com.mcvm_app.gamekeyprices_app.ui.category.strategy;
...
public class StrategyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        strategy_progressbar = view.findViewById(R.id.progressBar_strategy);
        strategy_progressbar.setVisibility(View.VISIBLE);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            strategy_progressbar.setVisibility(View.INVISIBLE);
